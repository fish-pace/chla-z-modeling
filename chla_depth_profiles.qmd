...
Caveat: Mostly trained on data from open ocean (BGC-Argo). Most data was for surface CHLA < 1. Need more coastal data. Though it does do a decent job for the coastal data and surface CHLA > 10 data that we do have.
<center>
